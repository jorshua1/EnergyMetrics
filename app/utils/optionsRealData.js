export const primaryEnergy = [
  {
    value: "primary-1",
    label: "Consumption - Exajoules (from 1965)",
    query: "primary_ej",
  },
  {
    value: "primary-2",
    label: "Consumption by fuel type - Exajoules (2020-2021)",
    query: "-",
  },
  {
    value: "primary-3",
    label: "Consumption per capita - Gigajoule per capita (from 1965)",
    query: "primary_ej_pc",
  },
];
export const Carbon = [
  {
    value: "carbon-1",
    label: "Carbon Dioxide Emissions from Energy (from 1965)",
    query: "co2_combust_mtco2",
  },
  {
    value: "carbon-2",
    label: "Natural gas flaring (from 1975)",
    query: "gasflared_bcm",
  },
  {
    value: "carbon-3",
    label: "Carbon Dioxide Emissions from Flaring (from 1975)",
    query: "gasflared_mtco2",
  },
  {
    value: "carbon-4",
    label:
      "Carbon Dioxide Equivalent Emissions from Methane and Process Emissions (from 1990)",
    query: "methane_process_mtco2",
  },
  {
    value: "carbon-5",
    label:
      "Carbon Dioxide Equivalent Emissions from Energy, Process Emissions, Methane, and Flaring (from 1990)",
    query: "co2_mtco2",
  },
];
export const Oil = [
